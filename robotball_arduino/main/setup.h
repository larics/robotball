...
// const float g_k1 = 1.54698741;  // Odometry calibration coefficient 1
// const float g_k2 = 1.13708371;  // Odometry calibration coefficient 2
// const float g_k3 = 1.36191262;  // Odometry calibration coefficient 3
...
//const float g_speed_scale =  0.724984012; // ^^^ This is the same ^^^
